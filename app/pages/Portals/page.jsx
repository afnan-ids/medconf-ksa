...
const portals = [
  {
    ...
    description:
      "Manage sponsorships, book exhibition space, and track contracts in real-time.",
    icon: Building2,
    ...
    <>
      ...
      <section className="relative py-8 sm:py-10 md:py-12 lg:py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
              ...
              return (
                <div key={index} className="group relative">
                  ...
                  <div className="relative h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-5 md:p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 sm:hover:-translate-y-2 overflow-hidden">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${portal.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
                    ></div>
                    ...
                    <div className="relative mb-4 sm:mb-5 md:mb-6 lg:mb-8">
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${portal.color} rounded-lg sm:rounded-xl md:rounded-2xl blur-md sm:blur-lg opacity-20 group-hover:opacity-40 transition-opacity duration-500`}
                      ></div>
                    ...
                    <ul className="space-y-1.5 sm:space-y-2 md:space-y-2.5 lg:space-y-3 mb-4 sm:mb-5 md:mb-6 lg:mb-8">
                      {portal.features.map((feature, idx) => (
                        ...
                        >
                          <div
                            className={`w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-gradient-to-r ${portal.color}`}
                          ></div>
                          {feature}
                        </li>
                      ))}
                    ...
                    {/* Bottom accent line */}
                    <div
                      className={`absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r ${portal.color} scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}
                    ></div>
                  </div>
          ...
          {/* Af-ui-> Its empty For a reason  */}
          <div className="mt-12 sm:mt-16 md:mt-20 lg:mt-24 text-center">
            {/* To consume Extra space in the bottom ! */}
          </div>
        </div>
