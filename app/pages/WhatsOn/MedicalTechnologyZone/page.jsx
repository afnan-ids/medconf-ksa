...
import { medicalTechnologyZoneTranslations } from "../../../il18/whatsOn/medicalTechnologyZone";

export default function MedicalTechnologyZone() {
  const { language } = useLanguage();
  const t =
    medicalTechnologyZoneTranslations[language] ||
    medicalTechnologyZoneTranslations.en;
  ...
  const exhibitorsData = [
    ...
    {
      name: t.cernerOracleHealth,
      logo: Cpu,
      category: "it",
      description: t.cernerDescription,
    ...
    },
    {
      ...
      logo: Activity,
      category: "equipment",
      description: t.zimmerDescription,
  ...
  const categories = [
    { id: "all", name: t.allExhibitors, icon: Building2 },
    { id: "equipment", name: t.medicalEquipment, icon: Microscope },
    { id: "surgical", name: t.surgicalDevices, icon: Scan },
    { id: "monitoring", name: t.patientMonitoring, icon: Activity },
    { id: "it", name: t.healthcareIT, icon: Server },
  ];

  const liveDemos = [
    {
      time: "10:00 AM - 10:45 AM",
      product: t.daVinciRoboticSystem,
      exhibitor: "Intuitive Surgical",
      booth: "#205",
      type: t.handsOnDemo,
    },
    {
      time: "11:00 AM - 11:45 AM",
      product: t.aiEnhancedMRI,
      exhibitor: "Siemens Healthineers",
      booth: "#101",
      type: "Live Scan",
    },
    {
      time: "1:00 PM - 1:45 PM",
      product: "Next-Gen Patient Monitor",
      exhibitor: "Philips Healthcare",
      booth: "#108",
      type: t.productWalkthrough,
    },
    {
      time: "2:00 PM - 2:45 PM",
      product: t.cardiacDeviceIntegration,
      exhibitor: "Medtronic",
      booth: "#112",
      type: t.integrationDemo,
    },
    {
      time: "3:00 PM - 3:45 PM",
      product: t.ehrCloudPlatform,
      exhibitor: "Epic Systems",
      booth: "#203",
      type: t.softwareDemo,
    },
  ];
  ...
  const statsData = [
    ...
    },
    {
      icon: Microscope,
      value: "500+",
      label: t.productsOnDisplay,
      gradient: "from-purple-500 to-pink-400",
    },
    {
      icon: Users,
      value: "50+",
      label: t.liveDemosDaily,
      gradient: "from-amber-500 to-orange-400",
    },
    {
      icon: BadgeCheck,
      value: "30+",
      label: t.worldPremieres,
      gradient: "from-emerald-500 to-teal-500",
    },
  ];
  ...
  return (
    <>
      <BreadCrumb
        title={t.medicalTechnologyZone}
        backgroundImage="/Images/Home/Bread-crum-1.avif"
        path={[{ label: t.whatsOn }, { label: t.medicalTechnologyZone }]}
      />
                ...
                return (
                  <div key={index} className="group relative block">
                    <div className="relative h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl sm:rounded-2xl overflow-hidden hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500">
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${exhibitor.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
                      ></div>
                      ...
                      <div
                        className={`absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r ${exhibitor.gradient} scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}
                      ></div>
                    </div>
                  </div>
                );
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {liveDemos.map((demo, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col lg:flex-row items-start lg:items-center justify-between p-3 sm:p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3 sm:gap-4 mb-2 lg:mb-0">
                          <div className="text-xs sm:text-sm font-bold text-blue-400 min-w-[100px]">
                            {demo.time}
                          </div>
                          <div>
          ...
          <div className="mb-12 sm:mb-16 md:mb-20 relative">
            ...
            <div className="text-center mb-10 sm:mb-14 relative z-10">
              ...
              <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto">
                Disover the scale of medical technology innovation
              </p>
