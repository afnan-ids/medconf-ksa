      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center mb-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm font-medium text-gray-300">Events & Insights</span>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <p className="text-lg">Riyadh International Convention Center</p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-6 py-6 border-y border-white/10">
              <div className="text-center">
                <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">500+</p>
                <p className="text-sm text-gray-400 mt-1">Speakers</p>
              </div>
              <div className="text-center border-x border-white/10">
                <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">100+</p>
                <p className="text-sm text-gray-400 mt-1">Exhibitors</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">50+</p>
        ...
        <div className="relative mt-32 overflow-hidden rounded-3xl">
          ...
          <div className="relative py-16 px-8 text-center backdrop-blur-sm">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm font-medium text-white/90">Resources</span>
            </div>
