        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="text-center mb-20">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
              <MdEmojiEvents className="w-4 h-4 text-yellow-300" />
          ...
          <div className="relative">
            ...
            <div className=" grid lg:grid-cols-2 gap-12 items-center mb-40 rounded-2xl p-4 inset-0 bg-[url('/Images/Home/Bread-crum-1.avif')] bg-cover bg-center">
              <div className="relative group">
                {/* Glow effect */}
                <div className="absolute -inset-1 rounded-3xl opacity-20 group-hover:opacity-30 transition duration-700"></div>
              ...
              <div className="space-y-8">
                <div className="mb-3">
                  <span className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-300 px-4 py-2 rounded-full text-xs font-semibold border border-blue-500/30">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 text-gray-300">
                    ...
                    <p className="text-lg">26-03-2026</p>
                  </div>
                </div>

                {/* Stats - Updated with dark theme */}
                <div className="grid grid-cols-3 gap-6  border-y border-white/10">
