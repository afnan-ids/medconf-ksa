...
export default function UsersManagement() {
  ...
  const roles = [
    ...
    { value: "sponsor", label: "Sponsor", icon: Shield, color: "blue" },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="relative px-5 py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-medium flex items-center gap-2 overflow-hidden group transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2 bg-slate-800 border border-white/10 rounded-xl text-white focus:outline-none focus:border-blue-500/50 appearance-none cursor-pointer"
              >
                ...
                filteredUsers.map((user) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full border ${roleBadge.bg}`}
                        >
                          {roleBadge.label}
                        </span>
                       </td>
                      <td className="p-4">
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full border ${statusBadge.bg}`}
                        >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white/5 backdrop-blur-2xl rounded-2xl w-full max-w-3xl shadow-2xl border border-blue-500/20 animate-in zoom-in-95 duration-300">
        ...
        <form onSubmit={handleSubmit} className="relative p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-blue-500/50 transition-all"
              />
            </div>
          ...
          {/* Row 2: Password, Role, Company/License (conditional) */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {!isEdit && (
              <div>
                <label className="block text-xs font-medium text-gray-400 mb-1">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-blue-500/50 transition-all pr-10"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-slate-800 border border-white/10 rounded-xl text-white focus:outline-none focus:border-blue-500/50 appearance-none cursor-pointer"
              >
                {roles.map((role) => (
                  <option key={role.value} value={role.value}>
                    {role.label}
            ...
            {/* Conditional Field 1: Company Name for Exhibitor/Sponsor */}
            ...
            {/* Conditional Field 2: License ID for Healthcare Practitioner */}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onCancel}
      />
      <div className="relative bg-white/5 backdrop-blur-2xl rounded-2xl w-full max-w-sm shadow-2xl border border-blue-500/20 animate-in zoom-in-95 duration-300">
        <div className="relative p-6 text-center">
          ...
          <p className="text-sm text-gray-300 mb-6">
            ...
            <span className="text-white font-medium">{user?.name}</span>? This
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-red-500/30 transition-all"
            >
              Delete
            </button>
          </div>
