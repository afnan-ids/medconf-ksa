    ...
    <section className="relative overflow-hidden py-6 ">
      ...
      <div className="relative z-10  px-4 sm:px-6 lg:px-8 pt-17 ">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-600/30 via-gray-600/30 to-cyan-600/30 backdrop-blur-xl border border-cyan-500/40 shadow-2xl shadow-cyan-500/10 px-8 py-6 md:px-14 md:py-8">
          {/* Gold Corner Accents */}
          <div className="absolute top-4 left-4 w-12 h-12 border-t-2 border-l-2 border-cyan-500/60 rounded-tl-xl"></div>
          <div className="absolute top-4 right-4 w-12 h-12 border-t-2 border-r-2 border-cyan-500/60 rounded-tr-xl"></div>
          <div className="absolute bottom-4 left-4 w-12 h-12 border-b-2 border-l-2 border-cyan-500/60 rounded-bl-xl"></div>
          <div className="absolute bottom-4 right-4 w-12 h-12 border-b-2 border-r-2 border-cyan-500/60 rounded-br-xl"></div>

          {/* Breadcrumb */}
          <nav
            className="inline-flex items-center flex-wrap gap-2 rounded-full bg-black/30 backdrop-blur-sm border border-cyan-500/30 px-5 py-2.5 mb-8"
          ...
          {/* Floating Logo */}
          <div className="absolute right-20 top-14 perspective-1000">
