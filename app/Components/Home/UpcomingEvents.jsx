          ...
          <div className="p-4 sm:p-8 lg:p-12 max-w-7xl mx-auto relative">
            ...
            <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 md:mb-16 relative z-10">
              ...
              <p className="text-xs sm:text-sm md:text-lg text-gray-300 mt-3 sm:mt-6 max-w-2xl mx-auto px-4">
                Explore upcoming conferences, workshops, and exhibitions in
                Saudi Arabia.
              </p>
            </div>
              ...
              {events.map((event, index) => (
                ...
                >
                  ...
                  <div className="relative mb-3 sm:mb-4 md:mb-6">
                    ...
                    <div className="relative w-11 h-11 sm:w-13 sm:h-13 md:w-15 md:h-15 flex items-center justify-center rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-400 shadow-lg group-hover:scale-110 transition-transform duration-500">
