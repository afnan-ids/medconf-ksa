...
const SlideVexora = () => {
  return (
    <div className="relative w-full h-full bg-[url('/Images/Home/VeroxaSliderBackground.png')] bg-cover bg-center">
      <div className="relative z-10 w-full max-w-7xl mx-auto h-full grid grid-cols-1 lg:grid-cols-[40%_60%]  text-white lg:mt-20 pt-10">
        {/* Left Column */}
        ...
        <div className="w-full max-w-4xl mx-auto space-y-5 py-6 ">
          ...
          <div className="flex justify-end items-center gap-3 pt-1 lg:mt-15">
            <p className="text-4xl md:text-5xl lg:text-6xl font-black ">HEAL</p>
            ...
            <div className="p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className=" text-center">
                  <p className="text-xl font-bold text-blue-900">نوفمبر</p>
                  <p className="text-xl font-bold text-blue-900">2026</p>
                </div>
                ...
                <div className="flex text-center">
                  <p className="text-5xl font-bold text-blue-900">9 - 11</p>
                </div>
